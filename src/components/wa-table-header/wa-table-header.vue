    ...
    <div class="table-search">
      ...
      <div class="table-search-button-group" v-if="props.buttons.includes('columnDisplay') || props.buttons.includes('comSearch')">
        <el-dropdown v-if="props.buttons.includes('columnDisplay')" :max-height="380" :hide-on-click="false">
          <el-button class="table-search-button-item" :class="props.buttons.includes('comSearch') ? 'right-border' : ''" color="#dcdfe6" plain>
            <wa-icon size="14" name="el-icon-Grid" />
          </el-button>
          <template #dropdown>
            <el-dropdown-menu>
        ...
        <el-tooltip
          ...
          placement="top"
        >
          <el-button class="table-search-button-item" @click="baTable.table.showComSearch = !baTable.table.showComSearch" color="#dcdfe6" plain>
            <wa-icon size="14" name="el-icon-Search" />
          </el-button>
        </el-tooltip>
      </div>
    </div>
...
import ComSearch from '/@/components/wa-table/comSearch/index.vue'
