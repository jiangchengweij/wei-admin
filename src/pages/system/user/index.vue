...
const waTableIns = new waTableClass(
  ...
  // 表格数据
  {
    ...
    column: [
      ...
      { label: '用户名', prop: 'username', align: 'left', width: '200' },
      { label: '用户昵称', prop: 'nickname', align: 'center' },
      { label: '手机号码', prop: 'phone', align: 'center' },
      { label: '邮箱', prop: 'email', align: 'center' },
      { label: '角色', prop: 'role', align: 'center' },
      { label: '用户标签', prop: 'tags', align: 'center' },
      { label: '可登录应用', prop: 'dcloud_appid', align: 'center' },
      { label: '最后登陆时间', prop: 'last_login_date', align: 'center', width: '160', render: 'datetime' },
      {
        label: '操作',
        align: 'center',
        width: '150',
